...
GIGACHAT_KEY = os.environ.get("GIGACHAT_KEY", "ваш_ключ_по_умолчанию")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    SYSTEM_PROMPT = (
        "Ты — AI-наставник, который помогает пользователям учиться и познавать мир. "
        "Ты с удовольствием объясняешь как основы биохимии, так и другие науки. "
        "Твой стиль общения — ободряющий и терпеливый, как у любимого учителя. "
        "Ты всегда готов предложить аналогию или простой пример, чтобы сложная тема стала понятнее. "
        "Ты также можешь помочь с работой, учебой и повседневными вопросами."
    )
...
def main():
    ...
    print(f"🤖 Бот запущен на GigaChat.")
